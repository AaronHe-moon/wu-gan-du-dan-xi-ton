/*
 * JJInspectPreview.java
 *
 * Created on 2007年9月26日, 下午1:45
 ...
 */
public class JJInspectPreview extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("JJInspectPreview Initialization Failure", e);
    ...
    public void initializeComponent(){
        ...
        if(temp!=null){
            image_toBeShown.setUrl("/renderImage?table=InspectJJ&id="+temp.getIdBlueprint()+"&direction=0");
            ...
            txtGC.setText(temp.getBlueprintProject());
            txtXM.setText(temp.getProjectName());
            txtNM.setText(temp.getCategoryString());
            txtTH.setText(temp.getSnBlueprint());
            txtTZMC.setText(temp.getBlueprintName());
        }
    }
