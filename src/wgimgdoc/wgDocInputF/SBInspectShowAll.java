 ...
 */
public class SBInspectShowAll extends AbstractFragmentBean {
    ...
    private Hyperlink hyperlink_inspectSBDoc = new Hyperlink();

    public Hyperlink getHyperlink_inspectSBDoc() {
        return hyperlink_inspectSBDoc;
    }

    public void setHyperlink_inspectSBDoc(Hyperlink h) {
        this.hyperlink_inspectSBDoc = h;
    }
    ...
    public void init() {
        ...
        initalizeOjbectDataProvider();
    }
    
    public void initalizeOjbectDataProvider()
    {
        TBlueprintDeviceInspect temp=new TBlueprintDeviceInspect();
        temp.setIsChecked(Boolean.FALSE);
        inspectdeviceDataProvider.refreshByExample(temp);
    }
    /**
    ...
    private InspectDeviceProvider inspectdeviceDataProvider=new InspectDeviceProvider();

    public InspectDeviceProvider getInspectdeviceDataProvider() {
        return inspectdeviceDataProvider;
    }

    public void setInspectdeviceDataProvider(InspectDeviceProvider inspectdeviceDataProvider) {
        this.inspectdeviceDataProvider = inspectdeviceDataProvider;
    }
    ...
    public String hyperlink_view_action() {
        ...
        TBlueprintDeviceInspect temp=(TBlueprintDeviceInspect)inspectdeviceDataProvider.getObject(rk);
        
        map.put("BlueprintDeviceInspectObject",temp);
        return "ToSBInspectPreview";
    }

    public String hyperlink_inspectSBDoc_action() {
        // 待做事项：替换为您的代码
        Map map=getSessionBean1().getSessionMap();
