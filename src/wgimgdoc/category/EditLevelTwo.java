 ...
 */
public class EditLevelTwo extends AbstractPageBean {
    ...
    public void setDropDown(DropDown dd) {
        this.dropDown = dd;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("EditLevelTwo Initialization Failure", e);
    ...
    private TFixedCategory fcat = null;
    
    public TFixedCategory getFcat() {
        return fcat;
    }
    
    public void setFcat(TFixedCategory fcat) {
        this.fcat = fcat;
    }
    
    
    private void InitalCat(){
        fcat = (TFixedCategory) getSessionBean1()
        .getSessionMap().get("EditL2CategoryID");
    }
