 ...
 */
public class AddLevelOne extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("AddLevelOne Initialization Failure", e);
    ...
    public String btnAdd_action() {
        try {
            ...
            TFixedCategory fcatUp = (TFixedCategory) dao.findByProperty("categoryLevel", "0").get(0);
            TFixedCategory fcat = new TFixedCategory();
            fcat.setCategoryLevel("1");
            fcat.setCategoryName(txtName.getText().toString());
            fcat.setCategoryNo(txtNo.getText().toString());
            fcat.setIdUp(fcatUp.getIdCat());
